...
Enter the highest degree of poly1:2
...
Enter the highest degree of poly2:2
...
Expression 1 = 1.0+ 2.0x^1+ 2.0x^2
Expression 2 = 1.0+ 3.0x^1+ 4.0x^2
Expression after additon  = 2.0+ 5.0x^1+ 6.0x^2
